    ...
    <table class="min-w-full bg-white border border-gray-200">
        ...
        <tbody class="text-gray-700 text-sm font-light">
            ...
            <tr class="border-b border-gray-200 hover:bg-gray-100">
                ...
                <td class="py-3 px-6 text-left"><?= $product['quantidade'];?></td>
                <td class="py-3 px-6 text-center"><input type="checkbox" name="comprar"></td>
                <td class="py-3 px-6 text-center">
                    <a href="edit_product.php?id=<?= $product['id'];?>" class="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Trocar</a>
